// Test support for the `cn` CLI edges — one builder for a temp dir shaped like an Obsidian vault.
//
...
/**
 * Create `dir` as an Obsidian vault: `.obsidian/`, a `community-plugins.json` enabling cn's declared
